...
<Form style={{marginTop: '50px', marginRight:'50%', marginLeft:'1em', marginBottom:'50px', fontSize:'20px', color:'#1476A8'}} onSubmit={this.handleSubmit}>
  ...
  <FormGroup row>
      ...
      <Col sm={10}>
        <Input style={{height:'150px'}} type="textarea" name="text" value={this.props.message.message} id="exampleText" />
      </Col>
    </FormGroup>
    <Button type="submit" style={{marginLeft:'12em', marginBottom:'10px', color:'#1476A8'}}>Delete</Button>
      <hr className="my-4" />
